...
- `projects/*`: 실제 POC 앱과 독립 학습용 툴링 프로젝트
...
- `projects/fe-scan-rs`: Rust로 프론트엔드 툴링을 배우기 위한 CLI POC 기록
...
Rust 기반 프론트엔드 툴링 학습 트랙은 [docs/rust-fe-tooling-learning-plan.md](docs/rust-fe-tooling-learning-plan.md)와 [projects/fe-scan-rs](projects/fe-scan-rs/README.md)에 정리합니다.
